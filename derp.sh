...
# cloning DT
# device tree
git clone https://github.com/nothing-sus-2/device_xiaomi_chime.git --depth 1 -b 13.0 device/xiaomi/chime
# kernel tree
git clone https://github.com/hac4us06/kernel-xiaomi-electro.git --depth 1 -b 14-ksu kernel/xiaomi/chime
# vendor tree
